module module_classes
 ...
 !! Type for triangles
  ...
  type Triangle
     ...
     real*8 :: delta_str                                                ! delta in midpoint
     real*8 :: xi, eta                                                  ! viscosities on triangle 
     real*8 :: xi_resuid, eta_resuid                                    ! viscosities on triangle 
 ...
 !! Type for Elements (basis functions) (every element has different quantity of neighbour elements)  
  ...
  type Element
     ...
     real*8 :: visc_str                                                  ! viscosity in midpoint
     real*8 :: u_str(2)                                                  ! velocity in midpoint                                                   
 ...
 !! Sparce matrix in CSR format type
  ...
  subroutine init_matrix(this, nonzero, matr_size) 
  
    class(Matrix), intent(inout) :: this
    integer, intent(in) :: nonzero
    integer, intent(in) :: matr_size
   
    this%nonzero = nonzero
    this%matr_size = matr_size
    
    allocate(this%a(this%nonzero))
    allocate(this%ia(this%matr_size + 1))
