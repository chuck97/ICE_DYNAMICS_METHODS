module module_constants
  ...
  real*8, parameter :: h_grid = 30000d0                                            ! parameter of quazi-uniform mesh
  ...
  integer, parameter :: num_time_steps = 200      
  ...
  integer, parameter :: N_Picard = 35                                              ! number of Picard iteration      
