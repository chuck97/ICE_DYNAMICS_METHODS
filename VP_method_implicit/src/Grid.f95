...
subroutine plot_ParaView(List_of_Elements, List_of_Triangles, number_of_elements, number_of_triangles, num)
   ...
   OPEN(1, FILE = '/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/VP_method_implicit/graphics/plt'//itoa(num)//'.vtk')
   ...
   do i = 1, number_of_triangles
     ...
     write (1, *) List_of_Triangles(i)%sigma1
   ...
   do i = 1, number_of_triangles
     ...
     write (1, *) List_of_Triangles(i)%sigma2
   ...
   do i = 1, number_of_triangles
     ...
     write (1, *) List_of_Triangles(i)%sigma12
...
subroutine print_resudal(resudal_mass, num, total)
  ...
  OPEN(12, FILE = '/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/VP_method_implicit/resudal/resud'//itoa(num)//'.txt')
...
subroutine plot_GNU(List_of_Elements, number_of_elements)
   ...
   open(2,file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/VP_method_implicit/graphics/plt.txt')
...
subroutine write_nodals(List_of_Elements, number_of_elements, num)
  ...
  open(3, file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/VP_method_implicit/values/nodals/nodals'//itoa(num)//'.txt')
...
subroutine write_triangles(List_of_Triangles, number_of_triangles, num)
  ...
  open(4, file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/VP_method_implicit/values/triangles/triangles'//itoa(num)//'.txt')
