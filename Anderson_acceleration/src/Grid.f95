...
subroutine initialization(List_of_Triangles, List_of_Elements, List_of_Edges, number_of_triangles, number_of_elements, &
  ...
  data   bv /0, 0, 0, 1d6, 1d6, 1d6, 1d6, 0/
...
subroutine plot_ParaView(List_of_Elements, List_of_Triangles, number_of_elements, number_of_triangles, num)
   ...
   OPEN(1, FILE = '/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/Anderson_acceleration/graphics/plt'//itoa(num)//'.vtk')
   ...
   do i = 1, number_of_triangles
     ...
     write (1, *) List_of_Triangles(i)%sigma1/List_of_Triangles(i)%P_0
   ...
   do i = 1, number_of_triangles
     ...
     write (1, *) List_of_Triangles(i)%sigma2/List_of_Triangles(i)%P_0
   ...
   do i = 1, number_of_triangles
     ...
     write (1, *) List_of_Triangles(i)%sigma12/List_of_Triangles(i)%P_0
...
subroutine print_resudal(resudal_mass, num)

  real*8   :: resudal_mass(4000)
  integer  :: num, i
  
    
  OPEN(12, FILE = '/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/Anderson_acceleration/resudal/resud'//itoa(num)//'.txt')
...
subroutine plot_GNU(List_of_Elements, number_of_elements)
   ...
   open(2,file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/Anderson_acceleration/graphics/plt.txt')
...
subroutine write_nodals(List_of_Elements, number_of_elements, num)
  ...
  open(3, file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/Anderson_acceleration/values/nodals/nodals'//itoa(num)//'.txt')
...
subroutine write_triangles(List_of_Triangles, number_of_triangles, num)
  ...
  open(4, file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/Anderson_acceleration/values/triangles/triangles'//itoa(num)//'.txt')
