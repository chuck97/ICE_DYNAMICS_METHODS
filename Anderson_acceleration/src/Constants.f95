module module_constants
  ...
  real*8, parameter    :: delta_min = 2d-11                                          ! minimum value of coefficient delta
  ...
  real*8, parameter    :: alpha_Anderson = 1d-12                                     ! alpha for anderson acceleration
  integer, parameter   :: m_Anderson = 20                                            ! degrees of freedom for Anderson acceleration
  integer, parameter   :: num_anderson_iterations = 100                              ! number of anderson iterations
  !real*8, parameter    :: resid_scale = 1d0                                         ! residual scale parameter
