...
subroutine plot_ParaView(List_of_Elements, List_of_Triangles, number_of_elements, number_of_triangles, num)
   ...
   OPEN(1, FILE = '/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/mEVP_method/graphics/plt'//itoa(num)//'.vtk')
...
subroutine print_resudal(resudal_mass, size_res, num)

  implicit none

  integer, intent(in)  :: size_res, num
  real*8,  intent(in)  :: resudal_mass(size_res)
  integer              :: i
  
    
  OPEN(12, FILE = '/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/mEVP_method/resudal/resud'//itoa(num)//'.txt')
...
subroutine plot_GNU(List_of_Elements, number_of_elements)
   ...
   open(2,file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/mEVP_method/graphics/plt.txt')
...
subroutine write_nodals(List_of_Elements, number_of_elements, num)
  ...
  open(3, file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/mEVP_method/values/nodals/nodals'//itoa(num)//'.txt')
...
subroutine write_triangles(List_of_Triangles, number_of_triangles, num)
  ...
  open(4, file='/home/ibrae.ac.ru/s.s.petrov/Desktop/SEA_ICE/mEVP_method/values/triangles/triangles'//itoa(num)//'.txt')
